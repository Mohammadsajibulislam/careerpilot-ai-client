...
export default function AuthNotFound() {
  return (
    <div className="px-6 py-24 max-w-2xl mx-auto text-center min-h-screen flex flex-col items-center justify-center">
      <h1 className="font-display text-5xl font-semibold" style={{ color: "var(--cp-accent)" }}>
        404
      </h1>
      <p className="font-display text-xl font-semibold mt-4">Page not found</p>
